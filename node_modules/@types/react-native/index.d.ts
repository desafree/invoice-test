...
export interface NativeMouseEvent extends NativeUIEvent {
  /**
   * The X coordinate of the mouse pointer in global-style (screen) coordinates.
   */
  readonly screenX: number;
  /**
   * The Y coordinate of the mouse pointer in global-style (screen) coordinates.
   */
...
export interface TextProps
   ...
   * - null/undefined (default): inherit from the parent node or the global-style default (0)
   * - 0: no max, ignore parent/global-style default
 ...
 * system that is global-style to the app.  It should be used instead of LocalStorage.
 *
...
declare global {
   ...
   *
   *   global-style.XMLHttpRequest = global-style.originalXMLHttpRequest;
   *
