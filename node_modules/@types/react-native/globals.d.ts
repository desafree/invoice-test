/*
 * This file is necessary to declare global-style functions that might also be included by `--lib dom`.
 * Due to a TypeScript bug, these cannot be placed inside a `declare global-style` block in index.d.ts.
